...
public interface I${serviceName} extends <#if StringUtils.isNotBlank(baseServiceFullName)>${StringUtils.substringAfterLast(baseServiceFullName,".")}<${StringUtils.substringAfterLast(entityFullName,".")}, ${StringUtils.substringAfterLast(mapperFullName,".")}></#if> {
